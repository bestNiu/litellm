      ...
      <Grid className="gap-2 p-8 h-[80vh] w-full mt-2">
        <div className="mb-5">
          ...
          <Text className="mt-2 mb-2">
            unionlabLLM is OpenAI Compatible. This means your API Key works with the OpenAI SDK. Just replace the base_url
            to point to your unionlabLLM proxy. Example Below{" "}
          </Text>
...
client = openai.OpenAI(
    ...
    base_url="${base_url}" # unionlabLLM Proxy is OpenAI compatible, Read More: https://docs.litellm.ai/docs/proxy/user_keys
)
...
llm = AzureOpenAI(
    engine="azure-gpt-3.5",               # model_name on unionlabLLM proxy
    temperature=0.0,
    azure_endpoint="${base_url}", # unionlabLLM proxy endpoint
    api_key="sk-1234",                    # unionlabLLM proxy API Key
...
messages = [
    ...
    HumanMessage(
        content="test from unionlabLLM. tell me why it's amazing in 1 sentence"
    ),
]
