...
${formattedBody}
  ...
  return (
    <div className="w-full m-2" style={{ overflow: "hidden" }}>
      ...
      <p className="text-sm text-gray-500">See how unionlabLLM transforms your request for the specified provider.</p>
      <div
        style={{
          display: "flex",
          gap: "16px",
      ...
      >
        ...
        >
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ color: "#666", margin: 0 }}>
              The request you would send to unionlabLLM /chat/completions endpoint.
            </p>
          </div>
        ...
        >
          <div style={{ marginBottom: "24px" }}>
            ...
            <p style={{ color: "#666", margin: 0 }}>How unionlabLLM transforms your request for the specified provider.</p>
            <br />
